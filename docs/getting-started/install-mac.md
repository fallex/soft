...
Универсальная инструкция — подходит для **любого** софта из этого хаба. Конкретный URL репо и название папки бери на странице нужного софта в разделе [📦 Софты](../softs/index.md).
...
URL клона возьми со страницы конкретного софта в разделе [📦 Софты](../softs/index.md). Дальше:
